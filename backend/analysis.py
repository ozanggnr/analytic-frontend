...
def analyze_stock(symbol: str, is_commodity=False, detailed=False):
    ...
    try:
        ...
        result = {
            ...
            "day_high": api_data.get('day_high') or api_data.get('high', 0),
            "day_low": api_data.get('day_low') or api_data.get('low', 0),
            "open": api_data.get('open') or api_data.get('o', 0),
            "previous_close": api_data.get('previous_close') or api_data.get('prev_close', 0),
